#!/usr/bin/env python3
"""
LSTM Stock Prediction - Training Script
========================================

Train LSTM models for multiple stock tickers with technical indicators.
Models are saved locally for real-time prediction.

USAGE:
    python train_lstm_stocks.py

ADDING NEW FEATURES:
    1. Add calculation in compute_technical_indicators()
    2. Add feature name to FEATURE_COLUMNS list
