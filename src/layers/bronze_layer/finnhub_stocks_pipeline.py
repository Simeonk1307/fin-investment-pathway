...
from src.utils.connectors.finnhub_stocks_subject import FinnhubSubject
...
producer_config = common_config | profiles["high_throughput"] | {"client.id": "finnhub-stocks-producer"}


logger.info("=" * 60)
logger.info("Finnhub → Redpanda Stocks Producer Starting...")
